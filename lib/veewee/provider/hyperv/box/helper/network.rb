    ...
    module Hyperv
      module BoxCommand
        ...
        def add_network_switch
          ...
          result = powershell_exec "$obj = Get-VMSwitch | Select -Property Name ; Foreach ($o in $obj) {if ($o.Name -eq '#{definition.hyperv_network_name}') {'reuse' ; exit}} ; New-VMSwitch -Name #{definition.hyperv_network_name} -EnableIov 1"
